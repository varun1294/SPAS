								...
								$dummy = $dummy."<li>
										<a href=\"#\">
											<div>
												...
												<div class=\"progress progress-striped active\">
													<div class=\"progress-bar progress-bar-$barColor[$i]\" role=\"progressbar\" aria-valuenow=\"80\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: $assignDaysRemPer[$i]%\">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                     <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Your Activities in DF, RLR & VLR
